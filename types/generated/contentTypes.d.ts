...
export interface ApiApiKeyApiKey extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rapidIgLooterApiKey: Schema.Attribute.String;
    smsActivateKey: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visionKey: Schema.Attribute.String;
  };
}
...
export interface ApiFarmedImageFarmedImage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '';
    displayName: 'Farmed Images';
    pluralName: 'farmed-images';
    singularName: 'farmed-image';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    folderPath: Schema.Attribute.String & Schema.Attribute.Required;
    gender: Schema.Attribute.Enumeration<['male', 'female']>;
    isUsed: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::farmed-image.farmed-image'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFbAccountFbAccount extends Struct.CollectionTypeSchema {
  collectionName: 'fb_accounts';
  info: {
    description: '';
    displayName: 'Facebook Accounts';
    pluralName: 'fb-accounts';
    singularName: 'fb-account';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    geo: Schema.Attribute.Enumeration<['UA', 'UNKNOWN']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'UNKNOWN'>;
    ...
    visionFingerprint: Schema.Attribute.JSON;
    visionProfileId: Schema.Attribute.String;
  };
}
